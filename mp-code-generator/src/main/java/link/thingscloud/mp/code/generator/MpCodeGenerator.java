...
public class MpCodeGenerator {
    ...
    private static final String className = System.getProperty("user.dir") + "/mp-code-generator/src/test/java";
    private static final String resourceName = System.getProperty("user.dir") + "/mp-code-generator/src/test/resources";

    public static String[] tableNames = new String[]{"access_key", "user", "user_group"};
...
//                        .setEntity("entity." + "demo")// 这里是控制器包名，默认 web
        ).setCfg(
